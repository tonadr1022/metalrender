...
class ABSL_ATTRIBUTE_WARN_UNUSED FixedArray {
 ...
 public:
  ...
  FixedArray(const FixedArray& other) noexcept(NoexceptCopyable())
      : FixedArray(other,
                   AllocatorTraits::select_on_container_copy_construction(other.storage_.alloc())) {
  }
  ...
  FixedArray(FixedArray&& other, const allocator_type& a) noexcept(NoexceptMovable())
      : FixedArray(std::make_move_iterator(other.begin()), std::make_move_iterator(other.end()),
                   a) {}
  ...
  const_pointer data() const ABSL_ATTRIBUTE_LIFETIME_BOUND { return AsValueType(storage_.begin()); }

  // Overload of FixedArray::data() to return a T* pointer to elements of the
  // fixed array. This pointer can be used to access and modify the contained
  // elements.
  pointer data() ABSL_ATTRIBUTE_LIFETIME_BOUND { return AsValueType(storage_.begin()); }
  ...
  const_iterator cbegin() const ABSL_ATTRIBUTE_LIFETIME_BOUND { return begin(); }
  ...
  // fixed array.
  const_iterator end() const ABSL_ATTRIBUTE_LIFETIME_BOUND { return data() + size(); }
  ...
  reverse_iterator rbegin() ABSL_ATTRIBUTE_LIFETIME_BOUND { return reverse_iterator(end()); }
  ...
  const_reverse_iterator crbegin() const ABSL_ATTRIBUTE_LIFETIME_BOUND { return rbegin(); }

  // FixedArray::rend()
  //
  // Returns a reverse iterator from the beginning of the fixed array.
  reverse_iterator rend() ABSL_ATTRIBUTE_LIFETIME_BOUND { return reverse_iterator(begin()); }
  ...
  //
  // Returns a reverse iterator from the beginning of the fixed array.
  const_reverse_iterator crend() const ABSL_ATTRIBUTE_LIFETIME_BOUND { return rend(); }
  ...
  friend bool operator!=(const FixedArray& lhs, const FixedArray& rhs) { return !(lhs == rhs); }

  friend bool operator<(const FixedArray& lhs, const FixedArray& rhs) {
    return std::lexicographical_compare(lhs.begin(), lhs.end(), rhs.begin(), rhs.end());
  }

  friend bool operator>(const FixedArray& lhs, const FixedArray& rhs) { return rhs < lhs; }
 ...
 private:
  ...
  using StorageElement = absl::conditional_t<std::is_array<value_type>::value,
  ...
  class NonEmptyInlinedStorage {
   ...
   private:
    ...
    alignas(StorageElement) unsigned char buff_[sizeof(StorageElement[inline_elements])];
  ...
  class Storage : public InlinedStorage {
   public:
    ...
    const allocator_type& alloc() const { return size_alloc_.template get<1>(); }

   private:
    static bool UsingInlinedStorage(size_type n) { return n <= inline_elements; }
